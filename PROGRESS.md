...
**P3-T06** — Build the mobile scroll-driven `ProjectStage`: non-sticky, inline, five-state, replacing the interim 200px illustration strip.
Dependencies P3-T02, P3-T01, P1-T07 are all complete.
